	...
	<body>
		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			...
			<ul class="nav navbar-nav">
				<li class="nav-item">
					<a class="nav-link" style="font-size: 23px" href="profile.php">Consultation des Points</a>

			
				<li class="nav-item">
					<a class="nav-link" style="font-size: 23px" href="logout.php">Se deconnecter[<?= $_SESSION['code']; ?>]</a>
				</li>
			</ul>
		</div>
	<!-- navigation end -->
<!-- navigation end -->
	<?php 
		...
		require_once('../model/selection_point-eleve.php');
	?>
