	...
	?>
		...
		<div class="panel panel-primary ">
			...
			<form method="get" action="" class="form-inline">
						...
						&nbsp;&nbsp;
						<a href="imprimer-eleve.php" class="btn btn-danger">Imprimer</a>
					</form>
		</div>
			</div>
		<div align="center">
				...
				<div class="panel panel-info spacer">
					...
					<div class="panel-body">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									<th>CODE</th><th>NOM_COMPLET</th><th>SEXE</th><th>NIVEAU</th><th>OPTION</th><th>CLASSE</th><th>ANNEE_SCOLAIRE</th><th></th>
								</tr>
							</thead>
							<tbody>
								...
								<td><a href="edit-eleve.php?id=<?php echo($et['code_eleve'])?>" class="btn btn-primary">Editer</a></td>
								<td></td>
											</tr>	
									<?php } ?>	
							</tbody>
