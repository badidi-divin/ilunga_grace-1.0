<?php
	...
	require_once '../model/authentification-2.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="contenair space col-md-6 col-xd-12 col-md-offset-3">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="a" style="font-weight:bold; font-size: 40px;">METTEZ VOTRE CODE</h3>
		</div>
		<div class="panel-body">
			<form method="post" action="">
				...
				<div class="control-label a">
					<button type="submit" class="btn btn-danger" name="formconnect">Consulter le points</button>
				</div>
			</form>
			<?php
			if (isset($erreur)) {
